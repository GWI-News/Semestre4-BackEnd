...
{
    /// <inheritdoc />
    public partial class gwinewsteste : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserWithNewsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_News_Users_UserWithNewsId",
                        column: x => x.UserWithNewsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_News_UserWithNewsId",
                table: "News",
                column: "UserWithNewsId");
